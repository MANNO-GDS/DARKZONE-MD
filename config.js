...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "MANNO-MD",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "˻•ᴍᴀͥɴͭɴͯ͢ᴏࠫ͠𐫰•˺ 👑♥️",           // Owner's name
    DEV: process.env.DEV || "923097045246",                     // Developer's contact number
    DEVELOPER_NUMBER: "923097045246@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𓂃ᷱ᪳𝀓͢ -𓆩〭〬𝐂υٹǝ֟፝͝ 🇦𝐑مᴀɴ♛ 🍫🥰🐭",     // Sticker pack name
    AUTO_STICKER: process.env.AUTO_STICKER || "false",          // Auto-send stickers?
    // ===== MEDIA & AUTOMATION =====
    AUTO_RECORDING: process.env.AUTO_RECORDING || "false",      // Auto-record voice notes?
    AUTO_TYPING: process.env.AUTO_TYPING || "false",            // Show typing indicator?
    MENTION_REPLY: process.env.MENTION_REPLY || "false",   // reply on mentioned message 
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://pmd-img2url.koyeb.app/v/01eea75b0b92e8cab35e090f1d889a15.jpg",  // Bot's "alive" menu mention image
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© CREATER ARMAN-2.0*",  // Bot description
